...
const spaceAnimationOne = keyframes`
  from {
...
const spaceAnimationTwo = keyframes`
  from {
...
const spaceAnimationThree = keyframes`
  from {
...
const spaceAnimationFourth = keyframes`
  from {
...
export const BoxAnimation = styled(Box)`
  color: #fad510;
  text-align: center;
  animation: ${titleAnimation} 5s ease-out;
`;

export const SpaceGalaxyContainer = styled(Box)`
  display: flex;
  width: 100%;
  height: 100%;
...
export const SpaceGalaxyBackground = styled(Box)`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
  ...
  .layer:nth-of-type(1) {
    animation: ${spaceAnimationOne} 5s linear infinite;
  }
  .layer:nth-of-type(2) {
    animation: ${spaceAnimationTwo} 5s linear infinite;
  }
  .layer:nth-of-type(3) {
    animation: ${spaceAnimationThree} 5s linear infinite;
  }
  .layer:nth-of-type(4) {
    animation: ${spaceAnimationFourth} 5s linear infinite;
  }
`;
